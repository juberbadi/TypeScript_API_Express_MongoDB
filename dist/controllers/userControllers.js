...
var signupUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, email, password, existingUser, hashedPassword, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                if (existingUser)
                    return [2 /*return*/, next((0, http_errors_1.default)(422, "Email already exists"))];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                if (!isValidPassword)
                    return [2 /*return*/, next((0, http_errors_1.default)(401, "Not a valid password!"))];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, jsonwebtoken_1.default.sign({ userId: user._id }, config_1.JWT_KEY, {
                        expiresIn: "60m"
                    })];
            case 4:
                jwtToken = _a.sent();
            ...
            case 6:
                ...
                // Preview URL: https://ethereal.email/message/WaQKMgKddxQDoou...
                _a.sent();
                res.status(200).json({ message: "Preview URL: %s, ".concat(nodemailer_1.default.getTestMessageUrl(info)) });
                return [3 /*break*/, 8];
            case 7:
                error_3 = _a.sent();
                return [2 /*return*/, next(http_errors_1.InternalServerError)];
