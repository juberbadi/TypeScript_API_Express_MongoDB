...
var sendVerificationMailValidation = function (req, res, next) {
    return (0, validator_1.default)(userSchema_1.userSchema.sendVerificationMail, req.body, next);
};
...
var sendForgotPasswordMailValidation = function (req, res, next) {
    return (0, validator_1.default)(userSchema_1.userSchema.sendForgotPasswordMail, req.body, next);
};
